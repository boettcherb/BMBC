...
#define ENOMEDIUM       135  /* Missing media */
#define EILSEQ          138  /* Invalid multibyte sequence */
#define EOVERFLOW       139  /* Value too large */
#define ECANCELED       140  /* Asynchrononous operation stopped before normal completion */
#define ENOTRECOVERABLE 141  /* State not recoverable */
#define EOWNERDEAD      142  /* Previous owner died */
#define ESTRPIPE        143  /* Streams pipe error  */

#endif // __BMBC_ERRNO_H_INCLUDED_
